...
// Path Compression and Union by Rank                 UnionFind 2
...
public class DisjointUnionSets {
    ...
    public DisjointUnionSets(int n) {
        rank = new int[n]; // defaults to 0 fill
        parent = new int[n];
        this.n = n;
        for (int i = 0; i < n; i++) {
    ...
    int find(int x) {
        ...
        if (parent[x] != x) {
            ...
            // Find the representative of parent and do path compression
...
class Main {
    public static void main(String[] args) {
        ...
        System.out.print("4 is a friend of 0:  ");
        ...
        System.out.print("1 is a friend of 0:  ");
